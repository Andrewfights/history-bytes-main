/**
 * PostModuleVideoScreen - Full-screen video player for post-module completion videos
 * Shows a celebration/summary video after a beat is completed, before XP screen
 *
 * Features:
...
import { Play, SkipForward, Volume2, VolumeX, Pause, Trophy } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black flex flex-col z-[60]">
          ...
          {!hasStarted && (
            ...
            >
              ...
              <motion.div
                ...
                className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center mb-4"
              >
              ...
              <motion.div
                ...
                className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-gradient-to-br from-green-500/30 to-green-600/30 backdrop-blur-md border-2 border-green-400/60 flex items-center justify-center"
              >
      ...
      >
        ...
        >
          ...
          {/* Progress fill - green for completion */}
          <div
            className="absolute left-0 h-1.5 bg-green-500 rounded-full group-hover:h-2 transition-all"
