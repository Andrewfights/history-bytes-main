/**
 * PreModuleVideoScreen - Minimal video player for pre-module intro videos
 * Design: Gold bracket corners, Oswald title, cream play button, gold progress bar
 */

import { useState, useRef, useCallback } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { SkipForward, Volume2, VolumeX, Pause } from 'lucide-react';
          ...
          <AnimatePresence>
            {!hasStarted && (
              ...
              >
                ...
                >
                  <h2 className="font-display text-xl sm:text-2xl font-bold uppercase tracking-[0.02em] text-off-white drop-shadow-[0_2px_14px_rgba(0,0,0,0.85)]">
                    {config.title || beatTitle}
                  </h2>
                  <p className="font-serif italic text-off-white/50 text-xs sm:text-sm mt-2 drop-shadow-[0_1px_6px_rgba(0,0,0,0.6)]">
                    Tap to play
                  </p>
                </motion.div>
